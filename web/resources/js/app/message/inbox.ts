...
@Component({
    ...
    templateUrl: window.SUB_DIRECTORY +"/html_components/member/message/inbox.html",
...
export class Inbox implements OnInit, OnDestroy {
    ...
    constructor(public router:Router, public route: ActivatedRoute, webAPIService: WebAPIService) {       
        ...
        this.webAPIService.getResponse(PacketHeaderFactory.getHeader(ACTION.FETCH_MESSAGE_INBOX_LIST)).then(result => {
