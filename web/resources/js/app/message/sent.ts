...
@Component({
    ...
    templateUrl: window.SUB_DIRECTORY +"/html_components/member/message/sent.html",
...
export class Sent implements OnInit, OnDestroy {
    ...
    constructor(public router:Router, public route: ActivatedRoute, webAPIService: WebAPIService) {        
        ...
        this.webAPIService.getResponse(PacketHeaderFactory.getHeader(ACTION.FETCH_MESSAGE_SENT_LIST)).then(result => {
            if (result.success)
            {
