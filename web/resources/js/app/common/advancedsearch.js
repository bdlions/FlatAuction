...
var AdvancedSearch = (function () {
    function AdvancedSearch(router, route) {
        this.router = router;
        this.route = route;
    ...
    AdvancedSearch.prototype.selectProduct = function (event, id) {
        this.router.navigate(['productinfo', { id: this.id }]);
    };
    AdvancedSearch.prototype.ngOnInit = function () {
        var _this = this;
    ...
    AdvancedSearch.prototype.ngOnDestroy = function () {
