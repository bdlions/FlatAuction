...
public class ClientMessages {
    public static final String REQUEST_DID_NOT_PROCESSED_SUCCESSFULLY = "Request didn't processed successfully.";
    public static final String PACKET_HEADER_MISSING = "Request packet header is missing.";
